...
<ApplicationLogo className="block h-10 w-auto text-blue-600" />
                        ...
                        <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <NavLink
                                ...
                                active={usePathname() === '/staff-dashboard'}>
                                Dashboard
                            </NavLink>
                            {user?.system_role?.name?.toLowerCase() === 'finance' && (
                                <>
                                    <NavLink
                                        ...
                                        active={usePathname() === '/fund-management'}>
                                        Fund Management
                                    </NavLink>
                                    <NavLink
                                        href="/pending-fund-requests"
                                        active={usePathname() === '/pending-fund-requests'}>
                                        Pending Fund Requests
                                    </NavLink>
                                    <NavLink
                                        href="/cash-disbursement"
                                        active={usePathname() === '/cash-disbursement'}>
                                        Cash Disbursement
                                    </NavLink>
                                    <NavLink
                                        href="/received-disbursements"
                                        active={usePathname() === '/received-disbursements'}>
                                        Received Disbursements
                                    </NavLink>
                                    <NavLink
                                        href="/finance-liquidation"
                                        active={usePathname() === '/finance-liquidation'}>
                            ...
                            {user?.system_role?.name?.toLowerCase() === 'director' && (
                                <>
                                    <NavLink
                                        ...
                                        active={usePathname() === '/director-liquidation'}>
                                        Liquidation Approvals
                                    </NavLink>
                                    <NavLink
                                        href="/liquidation-completed"
                                    ...
                                    <NavLink
                                        ...
                                        active={usePathname() === '/director-pending-fund-requests'}>
                                        Final Approvals
                                    </NavLink>
                                </>
                            )}
                            ...
                            {/* Cash Assistance Disbursements - Caseworker only */}
                            {user?.system_role?.name?.toLowerCase() === 'caseworker' && (
                                <NavLink
                                    href="/caseworker-disbursements"
                                    active={usePathname() === '/caseworker-disbursements'}>
                                    Cash Assistance Disbursements
                                </NavLink>
                            )}
                            {/* Liquidation Reports - Caseworker only */}
                            {user?.system_role?.name?.toLowerCase() === 'caseworker' && (
                                <NavLink
                                    href="/caseworker-liquidation"
                                    active={usePathname() === '/caseworker-liquidation'}>
                                    Liquidation Reports
                                </NavLink>
                            )}
                        </div>
                    ...
                    {/* Right-side actions: Notification bell (caseworker) + Settings */}
