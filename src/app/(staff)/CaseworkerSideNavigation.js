...
const CaseworkerSideNavigation = ({ user }) => {
    ...
    const navigationItems = [
        ...
        {
            name: 'Cash Assistance Disbursements',
            href: '/caseworker-disbursements',
            icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <>
            ...
            <aside className={`fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-lg border-r border-gray-200 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0`}>
                <div className="flex flex-col h-full">
                    <div className="flex items-center justify-center h-20 px-6 bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-800 shadow-lg">
                        <Link href='/staff-dashboard' className="transition-transform hover:scale-105">
                            <ApplicationLogo className="h-10 w-auto text-white" />
                        </Link>
                    </div>

                    <div className="px-6 py-6 bg-gradient-to-b from-indigo-50 to-white border-b border-indigo-100">
                        <div className="flex items-center">
                            <div className="flex-shrink-0">
                                <div className="h-12 w-12 rounded-full bg-gradient-to-br from-indigo-500 via-indigo-600 to-indigo-700 flex items-center justify-center shadow-md ring-2 ring-indigo-200">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-xs text-indigo-700 font-medium bg-indigo-100 px-2 py-1 rounded-full inline-block mt-1">Caseworker</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <nav className="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
                        <div className="mb-4">
                            <h3 className="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Workflows</h3>
                        </div>
                        {navigationItems.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    <span className={`mr-3 transition-colors duration-200 ${isActive ? 'text-white' : 'text-gray-500 group-hover:text-indigo-500'}`}>
                                        {item.icon}
                                    </span>
                    ...
                    <div className="px-6 py-6 border-t border-gray-200 bg-gray-50">
                        ...
                        <div className="mt-3 text-center">
                            <p className="text-xs text-gray-500">AidPoint v2.0</p>
                        </div>
                    </div>
                </div>
            </aside>
...
export default CaseworkerSideNavigation